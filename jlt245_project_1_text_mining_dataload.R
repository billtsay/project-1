...
tweets = searchTwitter("Election 2016", n=6000, lang='en', since="2016-10-01")
...
write.csv(dataFrame, file = "jlt245_project_1_text_mining_dataset_election.csv")

tweets = searchTwitter("Donald+Trump", n=6000, lang='en', since="2016-10-01")
# dataFrame <- twListToDF(tweets)
# Converting into dataframe may take 1 min or 2.
dataFrame <- do.call("rbind", lapply(tweets, as.data.frame))
write.csv(dataFrame, file = "jlt245_project_1_text_mining_dataset_trump.csv")

tweets = searchTwitter("Hillary+Clinton", n=6000, lang='en', since="2016-10-01")
# dataFrame <- twListToDF(tweets)
# Converting into dataframe may take 1 min or 2.
dataFrame <- do.call("rbind", lapply(tweets, as.data.frame))

write.csv(dataFrame, file = "jlt245_project_1_text_mining_dataset_hillary.csv")
